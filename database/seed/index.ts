...
async function main(): Promise<void> {
  ...
  const defaultTemplates: Array<{
    ...
    {
      code: 'auth.vault_recovery_requested',
      name: 'Vault recovery requested',
      category: 'SECURITY',
      channel: 'EMAIL',
      subject: 'A new device is requesting wallet access',
      body: 'Hello {{name}}, a device ({{platform}}) requested trusted-device recovery for your Auvora wallet. Approve or deny from a signed-in trusted device. Auvora never emails recovery phrases or keys.',
    },
    {
      code: 'auth.vault_recovery_requested',
      name: 'Vault recovery requested',
      category: 'SECURITY',
      channel: 'IN_APP',
      subject: 'New device recovery request',
      body: 'Hello {{name}}, approve or deny the pending wallet recovery request from {{platform}}.',
    },
    {
      code: 'auth.vault_recovery_approved',
      name: 'Vault recovery approved',
      category: 'SECURITY',
      channel: 'EMAIL',
      subject: 'Trusted-device recovery approved',
      body: 'Hello {{name}}, a trusted device approved wallet recovery. Complete setup on the requesting device with your new password.',
    },
    {
      code: 'auth.vault_recovery_approved',
      name: 'Vault recovery approved',
      category: 'SECURITY',
      channel: 'IN_APP',
      subject: 'Recovery approved',
      body: 'Hello {{name}}, trusted-device recovery was approved. Finish on the new device.',
    },
    {
      code: 'auth.vault_recovery_denied',
      name: 'Vault recovery denied',
      category: 'SECURITY',
      channel: 'EMAIL',
      subject: 'Trusted-device recovery denied',
      body: 'Hello {{name}}, a recovery request for your wallet was denied. If this was not you, secure your account.',
    },
    {
      code: 'auth.vault_recovery_denied',
      name: 'Vault recovery denied',
      category: 'SECURITY',
      channel: 'IN_APP',
      subject: 'Recovery denied',
      body: 'Hello {{name}}, the wallet recovery request was denied.',
    },
    {
      code: 'auth.vault_recovery_completed',
      name: 'Vault recovery completed',
      category: 'SECURITY',
      channel: 'EMAIL',
      subject: 'Wallet recovery completed',
      body: 'Hello {{name}}, trusted-device wallet recovery finished and your password was updated. Sign in with your new password.',
    },
    {
      code: 'auth.vault_recovery_completed',
      name: 'Vault recovery completed',
      ...
      body: 'Hello {{name}}, wallet recovery completed. Use your new password to sign in.',
    },
    {
    ...
    },
    {
      ...
      body: 'Hello {{name}}, your {{amount}} {{assetCode}} transfer on {{network}} is complete. Reference: {{txHash}}.',
    },
    {
      code: 'transaction.completed',
      name: 'Transfer completed',
