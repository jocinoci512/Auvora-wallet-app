...
| Resilience metrics  | http://localhost:4000/metrics/resilience _(send `x-internal-api-key` when required)_ |

---

_Document generated for Phase 14 Release Candidate. Statuses reflect repository evidence as of 2026-07-26; refresh BUILD_STATUS and checklist after staging certification._
