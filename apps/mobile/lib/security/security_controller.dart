...
class SecurityController extends ChangeNotifier {
  ...
  static final _demoSessions = [
    ActiveSession(
      ...
      loginAt: DateTime.now().subtract(const Duration(hours: 6)),
      lastActiveAt: DateTime.now(),
    ...
    ActiveSession(
      ...
      platform: 'Web',
      location: 'Approximate · Unknown region',
      loginAt: DateTime.now().subtract(const Duration(days: 3)),
  ...
  static final _demoAlerts = [
    SecurityAlertItem(
      ...
      description: 'A previously unseen browser connected to the wallet preview environment.',
      recommendedAction: 'Review trusted devices and revoke anything unfamiliar.',
      severity: SecurityStatus.fair,
      timestamp: DateTime.now().subtract(const Duration(hours: 8)),
    ),
    SecurityAlertItem(
      id: 'alert-backup',
      title: 'Recovery phrase needs verification',
      description: 'The phrase may be backed up, but it has not been verified recently.',
      recommendedAction: 'Run recovery verification from Security Center.',
      severity: SecurityStatus.good,
