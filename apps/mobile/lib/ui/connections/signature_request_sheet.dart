    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _row(
            'Can this affect assets?',
            request.canMoveFunds
                ? 'Yes — Permit / allowance signatures can approve token spending'
                : 'Unlikely for a plain message signature',
          ),
          ...
          const SizedBox(height: 8),
          const Text(
            'Preview signing — no live relay broadcast.',
