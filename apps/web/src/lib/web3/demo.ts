...
export const DEMO_REQUESTS: ConnectionRequest[] = [
  {
    ...
    permissions: ['VIEW_ADDRESSES', 'REQUEST_TRANSACTIONS', 'NETWORK_SWITCH'],
    status: 'pending',
...
export const DEMO_PERMISSIONS: PermissionGrant[] = [
  {
    ...
    origin: 'https://app.uniswap.org',
    account: '0x1111…1111',
    permission: 'REQUEST_TRANSACTIONS',
    network: 'ETHEREUM',
...
export const DEMO_ACTIVITY: Web3ActivityItem[] = [
  {
    ...
    detail: 'Approved VIEW_ADDRESSES · REQUEST_TRANSACTIONS',
    origin: 'https://app.uniswap.org',
  ...
  },
  {
    ...
    detail: 'REQUEST_SIGNATURES removed for Aave',
    origin: 'https://app.aave.com',
  ...
  },
  {
    id: 'wa5',
    kind: 'security',
    title: 'Phishing warning (placeholder)',
    detail: 'Blocked suspicious lookalike domain',
...
export const DEMO_SIGN: SignPreview = {
  ...
  simulation: 'Simulation placeholder — expected out ≥ 840 USDC',
