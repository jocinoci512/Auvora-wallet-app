...
import { AdminSwapsController } from './controllers/admin-swaps.controller';
import { InternalSwapsController } from './controllers/internal-swaps.controller';
...
@Module({
  ...
  controllers: [HealthController, SwapsController, AdminSwapsController, InternalSwapsController],
  providers: [
    JwtStrategy,
