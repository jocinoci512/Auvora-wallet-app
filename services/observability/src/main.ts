...
async function bootstrap(): Promise<void> {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Auvora Enterprise Observability & SRE Platform')
    .setDescription(
      'Metrics, tracing, logging, health, alerting, incidents, SLOs, and capacity monitoring for the Auvora Wallet platform',
    )
