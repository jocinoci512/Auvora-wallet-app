...
import { AdminMarketDataController } from './controllers/admin-market-data.controller';
import { InternalMarketDataController } from './controllers/internal-market-data.controller';
...
@Module({
  ...
  controllers: [
    ...
    AdminMarketDataController,
    InternalMarketDataController,
  ],
  providers: [
    JwtStrategy,
