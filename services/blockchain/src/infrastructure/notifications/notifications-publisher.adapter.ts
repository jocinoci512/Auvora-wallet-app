 ...
 * never fail the blockchain sync/confirmation flow that triggered it, so failures are logged, not
 * thrown. No-ops when NOTIFICATIONS_SERVICE_URL/INTERNAL_API_KEY are not configured.
 */
@Injectable()
