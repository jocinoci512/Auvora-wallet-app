...
@Injectable()
export class BnbSmartChainProvider extends BaseSimulatorProvider {
  constructor(
    ...
    super(prisma, networkConfig, ledger, ChainNetwork.BNB_SMART_CHAIN);
  }
  ...
  validateAddress(address: string): boolean {
    return validateAddressForChain(ChainNetwork.BNB_SMART_CHAIN, address);
  }

  protected defaultFee(): { base: string; unit: string } {
    return { base: '0.0005', unit: 'BNB' };
  }
}
