...
import { ProviderRpcHealthService } from '../src/application/services/provider-rpc-health.service';
...
describe('blockchain health (e2e)', () => {
  ...
  it('health endpoint returns ok', () => {
    ...
    expect(health.service).toBe('blockchain');
  });
