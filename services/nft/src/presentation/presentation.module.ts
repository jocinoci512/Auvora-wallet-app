...
import { AdminNftsController } from './controllers/admin-nfts.controller';
import { InternalNftsController } from './controllers/internal-nfts.controller';
...
@Module({
  ...
  controllers: [HealthController, NftsController, AdminNftsController, InternalNftsController],
  providers: [
    JwtStrategy,
