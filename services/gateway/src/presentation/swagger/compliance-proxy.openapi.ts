...
export function buildComplianceProxyOpenApiPaths(): OpenAPIObject['paths'] {
  ...
  return {
    ...
    '/api/v1/compliance/sanctions': proxyPath(
      'get',
      'Get own sanctions screening results',
      userTag,
    ),
    '/api/v1/compliance/pep': proxyPath('get', 'Get own PEP screening results', userTag),
    '/api/v1/admin/compliance/dashboard': proxyPath(
      'get',
      'Compliance dashboard metrics',
      adminTag,
    ),
    '/api/v1/admin/compliance/kyc/queue': proxyPath('get', 'KYC review queue', adminTag),
    '/api/v1/admin/compliance/kyc/{id}/approve': proxyPath(
      'post',
      'Approve KYC verification',
      adminTag,
    ),
    '/api/v1/admin/compliance/kyc/{id}/reject': proxyPath(
      'post',
    ...
    '/api/v1/admin/compliance/rules/{id}/enable': proxyPath(
      'post',
      'Enable compliance rule',
      adminTag,
    ),
    '/api/v1/admin/compliance/rules/{id}/disable': proxyPath(
      'post',
