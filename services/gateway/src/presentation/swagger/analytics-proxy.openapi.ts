...
export function buildAnalyticsProxyOpenApiPaths(): OpenAPIObject['paths'] {
  ...
  return {
    ...
    '/api/v1/admin/analytics/insights': proxyPath('get', 'Platform insights overview', adminTag),
    ...
    '/api/v1/admin/analytics/metrics/{code}': {
      ...proxyPath('get', 'Metric detail and time series', adminTag),
      ...proxyPath('patch', 'Update metric definition', adminTag),
    },
    '/api/v1/admin/analytics/forecasts': proxyPath('get', 'List forecast models', adminTag),
    '/api/v1/admin/analytics/forecasts/{code}': proxyPath('get', 'Forecast model and latest result', adminTag),
    '/api/v1/admin/analytics/aggregation/jobs': proxyPath('get', 'List aggregation jobs', adminTag),
    '/api/v1/admin/analytics/aggregation/run': proxyPath('post', 'Trigger aggregation run', adminTag),
    '/api/v1/admin/analytics/aggregate/run': proxyPath('post', 'Trigger aggregation run (alias)', adminTag),
    ...
    '/api/v1/admin/analytics/reports': proxyPath('get', 'List all reports', adminTag),
