...
export function buildCustodyProxyOpenApiPaths(): OpenAPIObject['paths'] {
  ...
  return {
    ...
    '/api/v1/custody/verify': proxyPath('post', 'Verify a signature', userTag),
    '/api/v1/custody/recovery/contacts': {
      ...proxyPath('get', 'List recovery contacts', userTag),
      ...proxyPath('post', 'Add recovery contact', userTag),
    },
    '/api/v1/custody/recovery/requests': {
      ...proxyPath('get', 'List recovery requests', userTag),
      ...proxyPath('post', 'Start recovery', userTag),
    },
    '/api/v1/custody/activity': proxyPath('get', 'Security activity / key audit', userTag),
    ...
    '/api/v1/admin/custody/approval-queue': proxyPath('get', 'Approval queue', adminTag),
    '/api/v1/admin/custody/recovery': proxyPath('get', 'Recovery dashboard', adminTag),
